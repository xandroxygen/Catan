...
public class MockServerProxy implements IServerProxy {
    ...
    public String gameGetModel(int version) {
    	switch(version){
    		...
    		case(3): return testModel3;	// the versions numbers mathch, the string "true" is returned
