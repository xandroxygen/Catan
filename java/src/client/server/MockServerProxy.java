...
public class MockServerProxy implements IServerProxy {
    ...
    public String gameGetModel(int version) {
    	switch(version){
    		...
    		case(4): return testModel4;	// the version numbers match, the string "true" is returned
